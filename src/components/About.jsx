    ...
    <div className="text-white">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 items-stretch">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="lg:col-span-5 relative group h-[400px] md:h-full lg:h-full"
        >
          <div className="relative h-full z-10 rounded-[2rem] md:rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl glass p-2 md:p-3">
            <div className="relative h-full rounded-[1.8rem] md:rounded-[2rem] overflow-hidden">
                <img
                ...
                {/* Floating Status */}
                <div className="absolute bottom-4 md:bottom-6 left-4 md:left-6 right-4 md:right-6 glass p-3 md:p-4 rounded-xl md:rounded-2xl flex items-center justify-between border-white/20">
                    <div className="flex flex-col">
                        <span className="text-[9px] md:text-[10px] uppercase tracking-widest text-gray-400 font-bold mb-0.5">Focus Area</span>
                        <span className="text-xs md:text-sm font-black">AI & Health Tech</span>
                    </div>
                    <div className="px-2 md:px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20 flex items-center gap-1.5 md:gap-2">
                        <div className="w-1 md:w-1.5 h-1 md:h-1.5 rounded-full bg-green-500 animate-pulse"></div>
                        <span className="text-[9px] md:text-[10px] font-bold text-green-400 uppercase tracking-tighter">Active Now</span>
                    </div>
                </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div 
                ...
                className="md:col-span-2 glass p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem]"
            >
            ...
            <motion.div 
                ...
                className="glass-hover p-6 md:p-8 rounded-[1.8rem] md:rounded-[2rem] border border-white/5 bg-white/[0.02] transition-all"
            >
